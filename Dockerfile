...
LABEL Name=ubuntu16-apache-php5.6 Version=0.0.1
...
RUN \
    ...
    # php5.6相關套件
    apt-get install -y libapache2-mod-php5.6 php5.6-bcmath php5.6-bz2 php5.6-cli php5.6-common php5.6-curl php5.6-dba php5.6-gd php5.6-gmp php5.6-imap php5.6-intl php5.6-ldap php5.6-mbstring php5.6-mcrypt php5.6-mysql php5.6-odbc php5.6-pgsql php5.6-recode php5.6-snmp php5.6-soap php5.6-sqlite php5.6-tidy php5.6-xml php5.6-xmlrpc php5.6-xsl php5.6-zip php5.6-fpm php5.6-json php-memcached && \
    apt-get install -y php-gnupg php-imagick php-mongodb php-streams php-redis php-fxsl php5.6-pdo && \
